...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <xsl:for-each select="marc:collection/marc:record">
            ...
            <xsl:value-of
                select="concat($field_035, $delimiter, $field_019, $delimiter, $LDR, $delimiter, $field_007, $delimiter, $field_008, $delimiter, $field_300, $delimiter, $field_336, $delimiter, $field_338, $delimiter, $field_533, $delimiter, $field_538, $delimiter, $field_776, $delimiter, $field_856, '&#13;')"
            />
        </xsl:for-each>
    </xsl:template>
</xsl:stylesheet>
